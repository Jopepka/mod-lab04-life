...
namespace TestNewOpportunity
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMethod2()
        {
            ...
            board.AddFigure(0, 40, settingsFigureCub);
            board.AddFigure(30, 20, settingsFigureCub);
            board.AddFigure(50, 50, settingsFigureCub);

            RenderInScottPlot renderInScott = new RenderInScottPlot();
            renderInScott.SavePict(board, settingsRender, pathSave + "ImageTest2.png");
            ...
            Assert.IsFalse(horizontalSymmetry);
